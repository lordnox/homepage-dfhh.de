angular.module('app').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('scripts/modules/app/templates/page-impressum.html',
    ...
    "<span class=\"style2\"><strong>Martina Hayward</strong></span></td>\n" +
    "    <td><p>Bovestraße 37</p>\n" +
    "    <p>22043 Hamburg</p>\n" +
    "    <p>&nbsp;</p>\n" +
    ...
    "<tr>\n" +
    "  <td>&nbsp;</td>\n" +
    "  <td><a href=\"www.discofox-hamburg.de\">www.discofox-hamburg.de</a></td>\n" +
    "</tr>\n" +
    "</table>\n" +
    "\n" +
    "\n" +
    ...
    "<table width=\"790\" border=\"0\" align=\"center\" cellpadding=\"5\" cellspacing=\"6\">\n" +
    "<tr>\n" +
    "  <td width=\"170\" valign=\"top\"><span class=\"style2\"><strong>Webdesign &amp; Fotos</strong></span></td>\n" +
    "  <td><p><strong>ViewStudio</strong></p>\n" +
    "    <p>Maris Stoeppler</p>\n" +
    "    <p>Bahrenfelder Chaussee 94</p>\n" +
    "    <p>22761 Hamburg</p>\n" +
    "    <p><a href=\"http://www.viewstudio.de\" target=\"_blank\">www.viewstudio.de</a></p></td>\n" +
    "</tr>\n" +
    "</table>\n" +
    "<p>&nbsp;</p>\n" +
    "<table width=\"790\" border=\"0\" align=\"center\" cellpadding=\"5\" cellspacing=\"6\">\n" +
    "<tr>\n" +
    "<td width=\"170\"><span class=\"style2\"><strong>Haftungsausschluss</strong></span></td>\n" +
    "<td><strong>1. Inhalt des Onlineangebotes</strong></td>\n" +
    "</tr>\n" +
    "<tr>\n" +
    "<td>&nbsp;</td>\n" +
    "    <td>Der   Autor übernimmt keinerlei Gewähr für die  Aktualität, Korrektheit,\n" +
    ...
    "<tr>\n" +
    "<td>&nbsp;</td>\n" +
    "<td><strong>2. Verweise und Links </strong></td>\n" +
    "</tr>\n" +
    "<tr>\n" +
    "<td>&nbsp;</td>\n" +
    "    <td>Bei direkten oder indirekten Verweisen auf fremde Internetseiten (&quot;Links&quot;),\n" +
    ...
    "<tr>\n" +
    "<td>&nbsp;</td>\n" +
    "<td><strong>3. Urheber- und Kennzeichenrecht </strong></td>\n" +
    "</tr>\n" +
    "<tr>\n" +
    "<td>&nbsp;</td>\n" +
    "    <td>Der   Autor ist bestrebt, in allen Publikationen die Urheberrechte der verwendeten Grafiken,\n" +
    ...
    "<tr>\n" +
    "<td>&nbsp;</td>\n" +
    "<td><strong>4. Datenschutz </strong></td>\n" +
    "</tr>\n" +
    "<tr>\n" +
    "<td>&nbsp;</td>\n" +
    "    <td>Sofern innerhalb des Internetangebotes die Möglichkeit zur Eingabe persönlicher oder geschäftlicher Daten\n" +
    ...
    "<tr>\n" +
    "<td>&nbsp;</td>\n" +
    "<td><strong>5. Rechtswirksamkeit dieses Haftungsausschlusses </strong></td>\n" +
    "</tr>\n" +
    "<tr>\n" +
    "<td>&nbsp;</td>\n" +
    "    <td>Dieser Haftungsausschluss ist als Teil des Internetangebotes zu betrachten,\n" +
    ...
    "    ihrer Gültigkeit davon unberührt.</td>\n" +
    "</tr>\n" +
    "<tr>\n" +
    "  <td>&nbsp;</td>\n" +
    "  <td>&nbsp;</td>\n" +
  ...
  $templateCache.put('scripts/modules/app/templates/page-news.html',
    ...
    "    <td>\n" +
    "      <p class=\"style2\">\n" +
    "        <strong>Herzlich Willkommen bei Discofox-Hamburg.de\n" +
    "        </strong>\n" +
    "      </p>\n" +
    "    </td>\n" +
    "\n" +
    ...
    "    </td>\n" +
    "    <td valign=\"top\">\n" +
    "      <p>Unsere Tanzschule hat sich auf die Tänze <strong>\n" +
    "        <a href=\"discofox.html\">Discofox\n" +
    "        </a>\n" +
    "      </strong> und <strong>\n" +
    "      <a href=\"westcoastswing.html\">West Coast Swing\n" +
    "      </a>\n" +
    "    </strong> spezialisiert. Wir bieten abgeschlossene Tanzkurse für Anfänger und Fortgeschrittene an. Für diejenigen, die länger tanzen wollen, gibt es einen attraktiven Clubbeitrag.\n" +
    "  </p>\n" +
    "  <p>&nbsp;\n" +
    "  </p>\n" +
    "  <p> <strong>Haben wir Ihr Interesse geweckt?\n" +
    "  </strong>\n" +
    "</p>\n" +
    "<p>\n" +
    "  Für weitere Fragen, melden Sie sich gerne Montags bis Samstags von 16.00 bis 18.00 Uhr bei:\n" +
    "</p>\n" +
    "<p>&nbsp;</p>\n" +
    "<p>\n" +
    ...
    "  <tr>\n" +
    "    <td width=\"100\">\n" +
    "      <strong class=\"style2\">Neu!\n" +
    "      </strong>\n" +
    "    </td>\n" +
    "    <td>\n" +
    "      <p>\n" +
    "        <strong>Lady / Men Styling\n" +
    "        </strong>\n" +
    "      </p>\n" +
    "    </td>\n" +
    "\n" +
    ...
    "    </td>\n" +
    "    <td valign=\"top\">\n" +
    "      <p>Neu im Programm ist unser Lady / Men Styling. Drehungen, Armbewegungen, Isolationen, Grundschrittvariationen. Das alles übt man am besten erst einmal allein.\n" +
    "      </p>\n" +
    "      <p>\n" +
    "        <strong>\n" +
    "          <a href=\"styling.html\">&gt; Zu den Terminen\n" +
    "          </a>\n" +
    "        </strong>\n" +
    "      </p>\n" +
    "    </td>\n" +
    ...
    "    </td>\n" +
    "    <td valign=\"top\">\n" +
    "      <p>Hier lernst du den Grundschritt und einfache Schrittkombinationen mit der dazugehörigen Technik.\n" +
    "      </p>\n" +
    ...
    "      </p>\n" +
    "      <p>\n" +
    "        <strong>7. Dezember 2013</strong>\n" +
    "      </p>\n" +
    "      <p>\n" +
    "        <strong>Workshop Special für Clubmitglieder:</strong>\n" +
    "        <br />\n" +
    "        Stephan Guttenberger, einer der erfolgreichsten Discofox\n" +
    "        Tänzer überhaupt, zeigt unseren Turnierpaaren, wie sie noch besser werden können.\n" +
    "      </p>\n" +
    "    </td>\n" +
    "  </tr>\n" +
    "</table>\n" +
    ...
    "    <td width=\"100\">\n" +
    "      <span class=\"style2\">\n" +
    "        <strong>West Coast Swing</strong>\n" +
    "      </span>\n" +
    "    </td>\n" +
    "    <td valign=\"top\">\n" +
    "      <p>\n" +
    "        <strong>Neue Termine für Einsteiger-Workshops</strong>\n" +
    "      </p>\n" +
    "    </td>\n" +
    "  </tr>\n" +
    "  <tr>\n" +
    "    <td>&nbsp;</td>\n" +
    "    <td>\n" +
    "      <p>Hier lernst du den Grundschritt und einfache Schrittkombinationen mit der dazugehörigen Technik. Dieser Workshop ist auch für Paare geeignet, die Sicherheit gewinnen wollen. Jeweils in der Zeit von 11.00 bis 14.00 Uhr.</p>\n" +
    "      <p>\n" +
    "        <br />\n" +
    "        <strong>Termine:</strong>\n" +
    "        <br />\n" +
    ...
    "      <p>&nbsp;</p>\n" +
    "      <p>\n" +
    "        <strong>Monatliche Workshops für Fortgeschrittene:</strong>\n" +
    "      </p>\n" +
    ...
    "      <p>\n" +
    "        <strong class=\"style2\">02.12.2013 &amp;</strong>\n" +
    "      </p>\n" +
    "      <p class=\"style2\">\n" +
    "        <strong>11.01.2014</strong>\n" +
    "      </p>\n" +
    ...
    "  <tr>\n" +
    "    <td>\n" +
    "      <p>Die Inhalte des Intensiv Workshops im August 2013 werden wiederholt und vertieft.</p>\n" +
    ...
    "    <td rowspan=\"2\" valign=\"top\">\n" +
    "      <p>\n" +
    "        <strong class=\"style2\">16.12.2013 &amp;</strong>\n" +
    "      </p>\n" +
    "      <p class=\"style2\">\n" +
    "        <strong>08.02.2014</strong>\n" +
    "      </p>\n" +
    "      <p>\n" +
    "        <span class=\"style3\">11.00-14.00 Uhr</span>\n" +
    "      </p>\n" +
    "    </td>\n" +
    "    <td>\n" +
    ...
    "    <td>\n" +
    "      <p>\n" +
    "        Die Inhalte des Workshops werden wiederholt. Dies geschieht besonders im Hinblick auf <strong>Technik</strong>.\n" +
    "      </p>\n" +
    "    </td>\n" +
    "\n" +
    "  </tr>\n" +
    "  <tr>\n" +
    "    <td>\n" +
    "      <strong class=\"style2\">21.12.2013</strong>\n" +
    "    </td>\n" +
    "    <td>\n" +
    "      <strong>West Coast Swing Intensiv</strong>\n" +
    "    </td>\n" +
    "\n" +
    "  </tr>\n" +
    "  <tr>\n" +
    "    <td>&nbsp;</td>\n" +
    "    <td>\n" +
    "      <p>West Coast Swing Intensiv mit &bdquo;The Man&ldquo; Douglas aus den USA, in der Zeit von 11.00 bis 15.00 Uhr im &bdquo;Tango Chocolate&ldquo;.\n" +
    "      </p>\n" +
    "      <p class=\"style2\">\n" +
    "        <strong>SOLD OUT\n" +
    "        </strong>\n" +
  ...
  $templateCache.put('scripts/modules/app/templates/page-styling.html',
    ...
    "<div id=\"content\">\n" +
    "<div id=\"title\">\n" +
    "  <p>Lady / Men Styling</p></div>\n" +
    "<p>&nbsp;</p>\n" +
    "<table width=\"790\" border=\"0\" align=\"center\" cellpadding=\"5\" cellspacing=\"6\">\n" +
    "\n" +
    "<tr>\n" +
    "<td><p><strong>Neu im  Programm ist unser Lady / Men Styling.</strong></p>\n" +
    ...
    "<table width=\"790\" border=\"0\" align=\"center\" cellpadding=\"5\" cellspacing=\"6\">\n" +
    "<tr>\n" +
    "  <td width=\"170\" valign=\"top\"><p class=\"style2\"><strong>Lady / Menstyling:</strong></p></td>\n" +
    "  <td width=\"170\" valign=\"top\"><strong>Mittwochs:</strong></td>\n" +
    "  <td><p>21.00 - 22.00  Uhr (durchgehend)</p>\n" +
    "Veranstaltungsort: Wandsbek</td>\n" +
    "</tr>\n" +
    "</table>\n" +
    "<p>&nbsp;</p>\n" +
    "<p>&nbsp;</p>\n" +
  ...
  $templateCache.put('scripts/modules/app/templates/page-trainerin.html',
    ...
    "<p>&nbsp;</p>\n" +
    "<table width=\"790\" id=\"table2\" border=\"0\" align=\"center\" cellpadding=\"5\" cellspacing=\"6\">\n" +
    "\n" +
    "<tr>\n" +
    "<td valign=\"top\"><p><strong>Martina Hayward</strong> tanzte sich im Alter von 17 Jahren als Norddeutscher Meister der A-Klasse\n" +
    "    auf Anhieb in das Finale von Blackpool, einem hochrangigen Tanzturnier. </p>\n" +
    "<p>&nbsp;</p>\n" +
    "    <p>Mit 22 Jahren beschloss sie dann mit dem  Leistungssport aufzuhören, neugierig studierte\n" +
    "    sie Geschichte und Russisch. </p>\n" +
    "    <p>&nbsp;</p>\n" +
    "    <p>Später wechselte sie zu Diplompädagogik mit dem Schwerpunkt Pädagogische Psychologie an der\n" +
    "    Universität Hamburg. Theaterarbeit, Atemtechnik und der  bewusste Umgang mit Körpersprache\n" +
    "    prägen ihre Arbeit. Martina ist ausgebildete  Farb-, Image- und Stilberaterin. </p>\n" +
    "    <p>&nbsp;</p>\n" +
    "    <p><strong>&quot;Seit über 20 Jahren arbeite ich als Tanzlehrerin. In den  letzten Jahren habe\n" +
    "    ich mich auf die Tänze West Coast Swing und Discofox  spezialisiert. Da ich selbst bis in die\n" +
    "    höchste deutsche Turnierklasse  (S-Klasse) getanzt habe, weiß ich, wie viel Zeit Turnierpaare\n" +
    "    in das Tanzen investieren. </strong></p>\n" +
    "    <p>&nbsp;</p>\n" +
    "    <p><strong>Da aber Zeit unser kostbarstes Gut ist, habe ich ein Konzept  entwickelt, hochklassiges\n" +
    "    Tanzen in kürzerer Zeit zu vermitteln. Wirklich  effektiv ist dies fast nur über Privatunterricht\n" +
    "    möglich aber auch in meinen  Tanzkursen erreiche ich erstaunliche Ergebnisse und andere Trainer\n" +
    "    sind immer  wieder überrascht, mit welcher Geschwindigkeit sich meine Paare entwickeln.&quot;</em></strong></p>\n" +
    "    <p>&nbsp;</p></td>\n" +
    "<td width=\"256\" valign=\"top\"><p><img src=\"pics/martina_hayward2.jpg\" alt=\"Martina Hayward\" width=\"250\" height=\"364\" /></p></td>\n" +
    "</tr>\n" +
    "\n" +
    "<tr>\n" +
    "<td></td>\n" +
  ...
  $templateCache.put('scripts/modules/app/templates/page-veranstaltungen.html',
    ...
    "<table width=\"790\" border=\"0\" align=\"center\" cellpadding=\"5\" cellspacing=\"6\">\n" +
    "<tr>\n" +
    "<td align=\"center\" class=\"style2\"><p><strong>Zur Zeit sind keine Veranstaltungen geplant.</strong><strong></strong></p></td>\n" +
    "</tr>\n" +
    "</table>\n" +
    "<p>&nbsp;</p>\n" +
    "<p>&nbsp;</p>\n" +
